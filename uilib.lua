...
function library:Init(key)
    ...
    headerLabel.TextColor3 = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(61, 135, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(128, 94, 208))}
    ...
    function TabLibrary:NewTab(title)
        ...
        function Components:NewButton(text, callback)
            ...
            button.MouseButton1Down:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = Color3.fromRGB(61, 135, 255)}):Play()
            end)
        ...
        function Components:NewSelector(text, default, list, callback)
            ...
            for i,v in next, list do
                ...
                if optionButton.Text == default then
                    optionButton.TextColor3 = Color3.fromRGB(61, 135, 255)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    ...
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = Color3.fromRGB(61, 135, 255)}):Play()
